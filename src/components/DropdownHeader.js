...
export default function DropdownHeader(props) {
  ...
  return (
    ...
    <div>
      ...
      <ArrowDropDownIcon onClick={handleClick} style={{ float: "right" }} />
      <StyledMenu
        id="demo-customized-menu"
        MenuListProps={{
          "aria-labelledby": "demo-customized-button",
        ...
        <div style={{ minWidth: "122px", transform: "translate(0px, 0px)" }}>
          <div>
            <div className="dropdown-header">
              <ul
                className="rounded dark text-white overflow-auto light-scrollbar menu"
                role="menu"
                style={{
                  minWidth: "180px",
                  maxWidth: "400px",
              ...
              >
                <li
                  data-tutorial-selector-id="columnMenuItem-changeType"
                  tabindex="0"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                  <input value={value} onChange={handleChange} />
                  &nbsp;
                  <button style={{ padding: "3px 5px" }} onClick={() => onSave(value)}>
                    Save
                  </button>
                </li>
                <li
                ...
                <li
                  data-tutorial-selector-id="columnMenuItem-editDescription"
                  tabindex="0"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                ...
                <li
                  data-tutorial-selector-id="columnMenuItem-editPermissions"
                  tabindex="0"
                  aria-disabled="false"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      fill="currentColor"
                      d="M12.636 7.91V6.726C12.636 4.364 10.52 2 7.91 2 5.3 2 3.182 4.334 3.182 6.727V7.91C2.529 7.91 2 8.442 2 9.08v4.75c0 .646.539 1.17 1.176 1.17h9.466a1.18 1.18 0 0 0 1.176-1.17V9.08a1.18 1.18 0 0 0-1.182-1.17zm-7.09 0h4.727V6.726s0-2.363-2.364-2.363-2.364 2.363-2.364 2.363V7.91z"
                    />
                  </svg>
                  <div className="ml1">Edit field permissions</div>
                </li>
                <li
                  data-tutorial-selector-id="columnMenuItem-duplicate"
                  tabindex="0"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      fill="currentColor"
                      d="M2.307 7.412c-.446.325-.44.858-.003 1.18l3.87 2.848c.456.31.826.116.826-.44v-1h4.994A1.998 1.998 0 0 0 14 8c0-1.105-.887-2-2.006-2H7V5c0-.552-.36-.74-.803-.42l-3.89 2.832z"
                    />
                  </svg>
                  <div className="ml1">Insert left</div>
                </li>
                <li
                  data-tutorial-selector-id="columnMenuItem-insertRight"
                  tabindex="0"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                  onClick={() => InsertRight(column.id, column.col_order)}
                >
                  <svg
                    width="16"
                    height="16"
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      fill="currentColor"
                      d="M9.826 4.57C9.37 4.262 9 4.455 9 5.01v1H4.006A1.998 1.998 0 0 0 2 8.01c0 1.105.887 2 2.006 2H9v1c0 .553.36.741.803.421l3.89-2.837c.446-.325.44-.858.003-1.18l-3.87-2.843z"
                    />
                  </svg>
                  <div className="ml1">Insert right</div>
                </li>
                <li
                  data-tutorial-selector-id="columnMenuItem-sortAscending"
                  tabindex="0"
                  aria-disabled="false"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                  ...
                  <div className="ml1">
                    <span>
                      Sort <span className="sortOrderLabel">A → Z</span>
                    </span>
                  </div>
                </li>
                <li
                  data-tutorial-selector-id="columnMenuItem-sortDescending"
                  tabindex="0"
                  aria-disabled="false"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                  ...
                  <div className="ml1">
                    <span>
                      Sort <span className="sortOrderLabel">Z → A</span>
                    </span>
                  </div>
                </li>
                <li
                  data-tutorial-selector-id="columnMenuItem-addFilter"
                  tabindex="0"
                  aria-disabled="false"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      fill="currentColor"
                      d="M5.5 13c0-.552.444-1 1-1h3c.552 0 1 .444 1 1 0 .552-.444 1-1 1h-3c-.552 0-1-.444-1-1zm-2-4c0-.552.446-1 .998-1h7.004c.551 0 .998.444.998 1 0 .552-.446 1-.998 1H4.498A.996.996 0 0 1 3.5 9zM1 4.5C1 3.672 1.675 3 2.498 3h11.004C14.329 3 15 3.666 15 4.5c0 .828-.675 1.5-1.498 1.5H2.498A1.495 1.495 0 0 1 1 4.5z"
                    />
                  </svg>
                  <div className="ml1">Filter by this field</div>
                </li>
                <li
                  data-tutorial-selector-id="columnMenuItem-groupBy"
                  tabindex="0"
                  aria-disabled="false"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
                ...
                <li
                  data-tutorial-selector-id="columnMenuItem-hide"
                  tabindex="0"
                  aria-disabled="false"
                  className="flex items-center p1 pointer lighten2-focus"
                  role="menuitem"
