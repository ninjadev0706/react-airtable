...
export default function DropdownSort(props) {
  ...
  const id = open ? "group-columns" : undefined;
  const classes = useStyles();


  return props.buttonId === "group-btn" ? (
    <div>
      <Popover
        id={id}
        open={open}
                        ...
                        <div className="p1-and-half">
                          <div className="flex justify-between mx1 items-center">
                            <div className="flex items-center">
                              <p className="text-size-default text-color-quiet line-height-4 font-family-default font-weight-strong">Group by</p>
